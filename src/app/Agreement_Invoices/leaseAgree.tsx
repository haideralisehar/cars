    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.sectionContent}>
          <View style={styles.paymentTable}>
            <View style={styles.paymentRow}>
              <Text style={styles.paymentLabel}>{leaseData.paymentCycle} Rent</Text>
            ...
            <View style={styles.paymentRow}>
              <Text style={styles.paymentLabel}>Lease Duration</Text>
              <Text style={styles.paymentValue}>{leaseData.leaseDuration}</Text>
            </View>
            <View style={styles.paymentRow}>
              <Text style={styles.paymentLabel}>Payment Cycle</Text>
              <Text style={styles.paymentValue}>{leaseData.paymentCycle}</Text>
            </View>
            <View style={styles.paymentRow}>
              <Text style={styles.paymentLabel}>Payment Status</Text>
...
export const downloadLeaseAgreementPDF = async (leaseData: any) => {
  ...
  try {
    ...
    link.href = url;
    link.download = `lease_agreement_${leaseData.agreementRef || Date.now()}.pdf`;
